...
- Name: functional\02-navigation.spec.ts >> Navigation entre les pages >> charge la page Utilisateurs (/utilisateurs) sans erreur console
...
+     at async load (http://localhost:5173/src/pages/UsersPage.js?t=1784687659673:47:19)",
+   "Error: Non authentifié
+     at request (http://localhost:5173/src/services/api.js?t=1784687659645:14:15)
+     at async load (http://localhost:5173/src/pages/UsersPage.js?t=1784687659673:47:19)",
+ ]
...
- generic [ref=e3]:
  ...
  - generic [ref=e120]:
    ...
    - main [ref=e137]:
      - generic [ref=e138]:
        - generic [ref=e139]:
          - heading "Utilisateurs" [level=1] [ref=e140]
          - button "Ajouter" [ref=e141] [cursor=pointer]:
            - img [ref=e142]
            - generic [ref=e143]: Ajouter
        - generic [ref=e145]: Aucun utilisateur
```
