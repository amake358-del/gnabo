...
- Name: functional\02-navigation.spec.ts >> Navigation entre les pages >> charge la page Historique (/historique) sans erreur console
...
+     at request (http://localhost:5173/src/services/api.js?t=1784688001226:14:15)",
+   "Error: Non authentifié
+     at request (http://localhost:5173/src/services/api.js?t=1784688001226:14:15)",
+ ]
```
...
- generic [ref=e3]:
    ...
    - navigation [ref=e11]:
      ...
      - generic [ref=e20]:
        ...
        - link "Interventions" [ref=e81] [cursor=pointer]:
          - /url: /interventions
          - img [ref=e82]
          - generic [ref=e86]: Interventions
        - link "Caisse" [ref=e87] [cursor=pointer]:
          - /url: /caisse
          - img [ref=e88]
          - generic [ref=e91]: Caisse
      - generic [ref=e92]:
        - paragraph [ref=e93]: Administration
        - link "Paramètres" [ref=e94] [cursor=pointer]:
          - /url: /parametres
          - img [ref=e95]
          - generic [ref=e98]: Paramètres
        - link "Utilisateurs" [ref=e99] [cursor=pointer]:
          - /url: /utilisateurs
          - img [ref=e100]
          - generic [ref=e102]: Utilisateurs
        - link "Historique" [ref=e103] [cursor=pointer]:
          - /url: /historique
          - img [ref=e105]
  ...
  - generic [ref=e120]:
    ...
    - main [ref=e137]:
      - generic [ref=e138]:
        - heading "Historique des actions" [level=1] [ref=e139]
        - generic [ref=e141]: Aucune action enregistrée
```
