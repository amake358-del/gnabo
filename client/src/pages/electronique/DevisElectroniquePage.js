...
export function DevisElectroniquePage() {
    ...
    const [devisId, _setDevisId] = useState(null);
    useEffect(() => {
        if (!appareilId)
            return;
        (async () => {
    ...
    const calcLineTotal = (line) => line.quantite * line.prix_unitaire;
