...
function drawAppareilCard(doc, appareil, y) {
    const cardH = 42;
...
function drawAccessoires(doc, accessoires, y) {
    const sectionH = 24;
...
function drawDeliveryInfo(doc, date_livraison, y) {
...
export async function generateBonLivraisonPdf(data, settings) {
